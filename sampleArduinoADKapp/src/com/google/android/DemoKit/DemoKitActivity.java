...
public class DemoKitActivity extends Activity implements Runnable {
			...
			if (ACTION_USB_PERMISSION.equals(action)) {
				synchronized (this) {
					...
					if (intent.getBooleanExtra(
						...
						openAccessory(accessory, action);
					} else {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getLastNonConfigurationInstance() != null) {
			...
			openAccessory(mAccessory,"create");
		}
	...
	public void onResume() {
		...
		if (accessory != null) {
			if (mUsbManager.hasPermission(accessory)) {
				openAccessory(accessory,"resume");
			} else {
	...
	private void openAccessory(UsbAccessory accessory, String action) {
		
		Toast toast = Toast.makeText(getApplicationContext(), "action: " + action, Toast.LENGTH_LONG);
        toast.show();
